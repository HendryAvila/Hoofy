...
Adaptive workflow for ongoing development. Includes `sdd_explore` for pre-pipeline context capture.
...
Full greenfield specification — from vague idea to validated architecture.
